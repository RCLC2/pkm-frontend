...
export function WelcomePage() {
  ...
  useEffect(() => {
    ...
    // Create stats array
    setStats([
      { label: "Total Projects", value: projectStats.totalProjects.toString(), icon: BookOpen },
      { label: "Total Notes", value: projectStats.totalNotes.toString(), icon: FileText },
      { label: "Connections", value: projectStats.totalConnections.toString(), icon: Network },
      { label: "Avg Notes/Project", value: projectStats.averageNotesPerProject.toString(), icon: TrendingUp },
    ]);
      ...
      <S.WelcomeContainer>
        ...
        {methodology === "zettelkasten" && (
          <S.TipSection>
            ...
            <S.TipContent>
              <S.TipTitle>Zettelkasten Tip</S.TipTitle>
              <S.TipText>
                Focus on creating atomic notes - one idea per note. Use double
                brackets [[like this]] to create connections between your ideas.
              </S.TipText>
            </S.TipContent>
          </S.TipSection>
        )}
